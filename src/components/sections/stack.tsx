  ...
  return (
    <section id="stack" className="py-24 md:py-32 border-y border-white/[0.04]">
      <div className="px-6 max-w-6xl mx-auto mb-12 md:mb-16">
        ...
        />
        <p className="mt-6 inline-block font-mono text-[11px] tracking-[0.2em] uppercase text-emerald-200/90 border border-emerald-300/25 bg-emerald-300/[0.05] px-4 py-2">
