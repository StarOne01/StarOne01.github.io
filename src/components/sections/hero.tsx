  ...
  return (
    <section className="relative w-full min-h-[100svh] overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pb-28 md:pb-24">
        ...
        >
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 font-mono text-[10px] uppercase tracking-[0.25em] text-white/70 bg-white/[0.03] border border-white/10 rounded-full backdrop-blur-md">
        ...
        <motion.div
          ...
          className="mt-4 mb-6 flex items-center justify-center gap-3 font-mono text-[11px] tracking-[0.2em] uppercase text-white/35"
        >
          <span className="h-px w-8 bg-white/20" />
          <span>~/</span>
          <span className="text-white/55">@{site.handle}</span>
          <span className="h-px w-8 bg-white/20" />
        </motion.div>
        ...
        <motion.div
          ...
          className="text-base sm:text-lg md:text-xl text-white/65 font-light max-w-2xl mx-auto mb-8 md:mb-10 leading-relaxed"
        >
      ...
      >
        <Link
          href="#work"
          className="group flex flex-col items-center gap-3 font-mono text-[9px] tracking-[0.3em] uppercase text-white/30 hover:text-white/70 transition-colors"
        >
          <span>scroll</span>
