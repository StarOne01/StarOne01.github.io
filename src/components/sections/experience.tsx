...
const statusStyles: Record<string, string> = {
  ...
  past: "bg-white/[0.04] text-white/50 border-white/10 line-through decoration-white/30",
};
      ...
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col">
        <div className="pt-20 md:pt-24 px-6 max-w-6xl mx-auto w-full">
          ...
          <div className="mt-6 flex items-center gap-3 font-mono text-[10px] tracking-[0.25em] uppercase text-white/50">
            ...
            <div className="relative h-px flex-1 max-w-xs bg-white/10" aria-hidden>
              <motion.div
        ...
        <div className="flex-1 flex items-center">
          ...
          >
            {experience.map((item, i) => (
              ...
              >
                <div className="flex items-center justify-between mb-4 font-mono text-[10px] tracking-[0.2em] uppercase">
                  <span className="text-white/50" aria-hidden>/{String(i + 1).padStart(2, "0")}</span>
            ...
            <div className="shrink-0 w-[60vw] flex items-center justify-center font-mono text-[10px] tracking-[0.3em] uppercase text-white/40">
              → end of timeline
            </div>
          </motion.div>
        </div>
