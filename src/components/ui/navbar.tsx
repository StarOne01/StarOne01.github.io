...
function ThemeToggle() {
  ...
  return (
    <>
      ...
      {showMsg && (
        <div className="fixed bottom-16 left-1/2 -translate-x-1/2 z-50 bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-sm text-white/60 backdrop-blur-xl whitespace-nowrap">
